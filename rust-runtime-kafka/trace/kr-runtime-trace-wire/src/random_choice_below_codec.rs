...
pub use decoder::RandomChoiceBelowDecoder;
pub use encoder::RandomChoiceBelowEncoder;
...
pub mod encoder {
    ...
    pub struct RandomChoiceBelowEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RandomChoiceBelowEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RandomChoiceBelowEncoder<'a> {
        #[inline]
    ...
    impl<'a> RandomChoiceBelowEncoder<'a> {
        ...
        /// primitive field 'upperExclusive'
        /// - min value: 0
        /// - max value: -2
        /// - null value: 0xffffffffffffffff_u64
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn upper_exclusive(&mut self, value: u64) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct RandomChoiceBelowDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for RandomChoiceBelowDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RandomChoiceBelowDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RandomChoiceBelowDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RandomChoiceBelowDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
