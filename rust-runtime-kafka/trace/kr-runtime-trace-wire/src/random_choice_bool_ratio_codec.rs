...
pub use decoder::RandomChoiceBoolRatioDecoder;
pub use encoder::RandomChoiceBoolRatioEncoder;
...
pub mod encoder {
    ...
    pub struct RandomChoiceBoolRatioEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RandomChoiceBoolRatioEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RandomChoiceBoolRatioEncoder<'a> {
        #[inline]
    ...
    impl<'a> RandomChoiceBoolRatioEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn numerator(&mut self, value: u64) -> &mut Self {
            let offset = self.offset + 48;
            self.get_buf_mut().put_u64_at(offset, value);
            self
        }

        /// primitive field 'denominator'
        /// - min value: 0
        /// - max value: -2
        /// - null value: 0xffffffffffffffff_u64
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn denominator(&mut self, value: u64) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct RandomChoiceBoolRatioDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for RandomChoiceBoolRatioDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RandomChoiceBoolRatioDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RandomChoiceBoolRatioDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RandomChoiceBoolRatioDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
