...
pub use decoder::RuntimeStalledDecoder;
pub use encoder::RuntimeStalledEncoder;
...
pub mod encoder {
    ...
    pub struct RuntimeStalledEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RuntimeStalledEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RuntimeStalledEncoder<'a> {
        #[inline]
    ...
    impl<'a> RuntimeStalledEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct RuntimeStalledDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for RuntimeStalledDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RuntimeStalledDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RuntimeStalledDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RuntimeStalledDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
